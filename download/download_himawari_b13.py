...
#     if band == "B03":
#         resolution = "R05"      # 0.5 km (Visible Red)
#     elif band in ["B01", "B02", "B04"]:
#         resolution = "R10"      # 1 km (Visible/NIR)
#     else:
#         resolution = "R20"      # 2 km (IR bands)
...
#     LOCAL_FILES = {
#         REMOTE_B03_CURR: "north_india_B03.dat.bz2",   # NEW (Visible)
#         REMOTE_B08_CURR: "north_india_B08.dat.bz2",
#         REMOTE_B13_CURR: "north_india_B13.dat.bz2",
#         REMOTE_B13_PREV: "north_india_B13_prev.dat.bz2",
#         REMOTE_B14_CURR: "north_india_B14.dat.bz2"
...
#     if success:
#         print("\n🎯 MULTI-BAND DOWNLOAD COMPLETE (Visible + IR)")
#     else:
#         print("\n⚠️ Some downloads failed. Check logs.")
